...
public class DialogsTest {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(DialogsTest.class);
	...
	public void testDefaultDialogs() throws Exception {
		...
		char[] pin = beIDCardUI.obtainPIN(2, PINPurpose.NonRepudiationSignature, "DSS");
		LOGGER.debug("PIN: {}", new String(pin));
		beIDCardUI.advisePINPadPINEntry(1, PINPurpose.NonRepudiationSignature, "DSS");
