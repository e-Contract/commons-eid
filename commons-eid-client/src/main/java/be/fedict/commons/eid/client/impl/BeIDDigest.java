...
public enum BeIDDigest {
	...
	RIPEMD_128(new byte[] { 0x30, 0x1b, 0x30, 0x07, 0x06, 0x05, 0x2b, 0x24,
			0x03, 0x02, 0x02, 0x04, 0x10 }),

	RIPEMD_160(new byte[] { 0x30, 0x1f, 0x30, 0x07, 0x06, 0x05, 0x2b, 0x24,
			0x03, 0x02, 0x01, 0x04, 0x14 }),

	RIPEMD_256(new byte[] { 0x30, 0x2b, 0x30, 0x07, 0x06, 0x05, 0x2b, 0x24,
