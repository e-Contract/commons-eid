...
public enum FileType {
	...
	IdentitySignature(new byte[] { 0x3F, 0x00, (byte) 0xDF, 0x01, 0x40, 0x32 }, 256),
	...
	AuthentificationCertificate(new byte[] { 0x3F, 0x00, (byte) 0xDF, 0x00, 0x50, 0x38 }, 1900, 0x82),

	NonRepudiationCertificate(new byte[] { 0x3F, 0x00, (byte) 0xDF, 0x00, 0x50, 0x39 }, 1900, 0x83),
	...
	BasicPublic(new byte[] { 0x3F, 0x00, (byte) 0xDF, 0x01, 0x40, 0x40 }, 120, 0x81);
