...
public enum Digest {
	...
	RIPEMD160("RIPEMD160", new byte[] { 0x30, 0x1f, 0x30, 0x07, 0x06, 0x05,
			0x2b, 0x24, 0x03, 0x02, 0x01, 0x04, 0x14 }),

	RIPEMD128("RIPEMD128", new byte[] { 0x30, 0x1b, 0x30, 0x07, 0x06, 0x05,
			0x2b, 0x24, 0x03, 0x02, 0x02, 0x04, 0x10 }),

	RIPEMD256("RIPEMD256", new byte[] { 0x30, 0x2b, 0x30, 0x07, 0x06, 0x05,
			0x2b, 0x24, 0x03, 0x02, 0x03, 0x04, 0x20 }),
