...
public enum Digest {
	...
	PLAIN_TEXT("2.16.56.1.2.1.3.1", new byte[]{0x30, (byte) 0xff, 0x30, 0x09,
			...
			(byte) 0xff}), SHA1("SHA1", new byte[]{0x30, 0x1f, 0x30, 0x07,
			0x06, 0x05, 0x2b, 0x0e, 0x03, 0x02, 0x1a, 0x04, 0x14}), SHA224(
			"SHA224", new byte[]{0x30, 0x2b, 0x30, 0x0b, 0x06, 0x09, 0x60,
					(byte) 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x04,
					0x04, 0x1c}), SHA256("SHA256", new byte[]{0x30, 0x2f, 0x30,
			0x0b, 0x06, 0x09, 0x60, (byte) 0x86, 0x48, 0x01, 0x65, 0x03, 0x04,
			0x02, 0x01, 0x04, 0x20}), SHA384("SHA384", new byte[]{0x30, 0x3f,
			0x30, 0x0b, 0x06, 0x09, 0x60, (byte) 0x86, 0x48, 0x01, 0x65, 0x03,
			0x04, 0x02, 0x02, 0x04, 0x30}), SHA512("SHA512", new byte[]{0x30,
			0x4f, 0x30, 0x0b, 0x06, 0x09, 0x60, (byte) 0x86, 0x48, 0x01, 0x65,
			0x03, 0x04, 0x02, 0x03, 0x04, 0x40}), RIPEMD160("RIPEMD160",
			new byte[]{0x30, 0x1f, 0x30, 0x07, 0x06, 0x05, 0x2b, 0x24, 0x03,
					0x02, 0x01, 0x04, 0x14}), RIPEMD128("RIPEMD128",
			new byte[]{0x30, 0x1b, 0x30, 0x07, 0x06, 0x05, 0x2b, 0x24, 0x03,
					0x02, 0x02, 0x04, 0x10}), RIPEMD256("RIPEMD256",
			new byte[]{0x30, 0x2b, 0x30, 0x07, 0x06, 0x05, 0x2b, 0x24, 0x03,
					0x02, 0x03, 0x04, 0x20}), SHA1PSS("SHA1PSS", new byte[]{},
			0x10), SHA256PSS("SHA256PSS", new byte[]{}, 0x20);
